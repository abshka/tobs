...
class TestMetadataExtractor:
    ...
    async def test_get_metadata_image_file(self, metadata_extractor, tmp_path):
    ...
    async def test_get_metadata_caching(self, metadata_extractor, tmp_path):
    ...
    async def test_get_metadata_image_pil_failure(self, metadata_extractor, tmp_path):
    ...
    async def test_get_file_hash_computation(self, metadata_extractor, tmp_path):
    ...
    async def test_get_file_hash_different_files(self, metadata_extractor, tmp_path):
    ...
    async def test_get_image_metadata(self, metadata_extractor, tmp_path):
