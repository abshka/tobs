...
class TestMediaCache:
    ...
    async def test_initialization_without_cache_manager(
        self, media_cache_no_manager
    ):
    ...
    async def test_copy_file_async(
        self, media_cache, tmp_path
    ):
    ...
    async def test_copy_file_async_large_file(
        self, media_cache, tmp_path
    ):
