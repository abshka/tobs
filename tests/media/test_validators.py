...
class TestMediaValidator:
    ...
    async def test_validate_file_integrity_empty_file(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_file_integrity_too_small(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_video_file_soft_valid_mp4(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_video_file_soft_valid_mkv(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_video_file_soft_valid_avi(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_video_file_soft_invalid(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_image_file_soft_valid_jpeg(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_image_file_soft_valid_png(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_image_file_soft_invalid(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_audio_file_soft_valid_mp3(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_audio_file_soft_valid_m4a(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_audio_file_soft_invalid(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_unknown_file_type(
        self, media_validator, tmp_path
    ):
    ...
    async def test_validate_file_exception_handling(
        self, media_validator, tmp_path
    ):
