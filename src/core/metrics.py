...
class MetricsCollector:
    ...
    def record_export_complete(
        ...
        if target_name not in self.exports:
            logger.warning(f"Export completion recorded for unknown target: {target_name}")
    ...
    def get_snapshot(self) -> Dict[str, Any]:
        ...
        snapshot = {
            ...
            "exports": {
                ...
                for name, metrics in self.exports.items()
            },
            "workers": {
        ...
        return {
            ...
            "by_worker": {
                worker_id: {
                    ...
                    "success_rate": w.tasks_completed / (w.tasks_completed + w.tasks_failed)
